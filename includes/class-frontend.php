...
class WC_Notify_Frontend {
    ...
    public static function add_notify_button() {
        ...
        echo '<button type="button" id="wc-notify-btn" class="button alt" data-product-id="' . esc_attr( $product->get_id() ) . '">Уведомить о наличии</button>';
    }
    ...
    public static function enqueue_scripts() {
        ...
        wp_enqueue_script( 'wc-notify-js', WC_NOTIFY_PLUGIN_URL . 'assets/wc-notify.js', [], '1.0.0', true );
