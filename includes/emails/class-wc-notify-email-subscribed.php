...
class WC_Notify_Email_Subscribed extends WC_Email {
	public function __construct() {
		$this->id             = 'wc_notify_subscribed';
		$this->title          = 'Подписка на появление товара';
		$this->description    = 'Это письмо отправляется клиенту при успешной подписке на уведомление о наличии товара.';
		$this->template_html  = 'emails/notify-subscribed.php';
		$this->template_plain = 'emails/plain/notify-subscribed.php';
	...
	public function get_default_subject() {
		return 'Подписка на уведомление: {product_title}';
	}
	public function get_default_heading() {
		return 'Вы подписаны на уведомление';
	}
